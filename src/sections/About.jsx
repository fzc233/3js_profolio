...
const About = () => {
   ...
   const handleCopy = ()=> {
       navigator.clipboard.writeText("isconor323@gmail.com");
       setHasCopied(true)
        ...
        <section className="c-space my-20" id="about">
            <div className="grid xl:grid-cols-3 xl:grid-rows-6 md:grid-cols-2 grid-cols-1 gap-5 h-full">
                    ...
                    <div className="grid-container">
                        ...
                        <div>
                            ...
                            <p className="grid-subtext">I specialize in JavaScript/TypeScript with a focus on React and
                                Next.js. I also have experience with Java and C# development.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="col-span-1 xl:row-span-4">
                    <div className="grid-container bg-black-200">  {/* ✅ 确保背景一致 */}
                        ...
                        <div className="grid-headtext">
                            <p>I work remotely across most timezones</p>
                ...
                <div className="xl:col-span-2 xl:row-span-3 ">
                    <div className="grid-container">
                        ...
                        <div>
                            ...
                            <p className="grid-subtext">I love making idea and solving problems. Coding isn't just my
                    ...
                    <div className="grid-container">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="copy-container" onClick={handleCopy}>
                                ...
                                <p className="lg:text-xl md:text-xl font-medium text-gray_gradient text-white">isconor323@gmail.com</p>
                            </div>
                        </div>
                    </div>
                </div>
